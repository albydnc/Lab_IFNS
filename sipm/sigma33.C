...
int nmisure = 8;
float n[8];
float sigma[] = {19.5889531204, 25.1942333486, 28.8259360599, 32.4067798227, 37.7147713333, 39.471538553, 46.4557342567, 53.3905598967};
float sn[8];
float ssigma[] = {4.2174583928, 3.9136187123, 3.7979923185, 3.7178507954, 3.636635151, 3.6164120419, 3.5567642801, 3.5186301158, 3.4983693636, 3.4743399497, 3.4553225552};
for (int j=0;j<8;j++){
n[j]=pow(j+1,0.5);
sn[j]=0.25/n[j];
}
